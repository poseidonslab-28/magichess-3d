...
const HERO_DATA = {
    ...
    k1: {
        ...
        stats: { hp: 6000, atk: 50, def: 35, spd: 0.6, range: 1 }, mana: { max: 70, start: 30 },
        skill: {
            name: 'Holy Strike',
            type: 'single',
            multiplier: 2.5,
            ...
            vfx: {
                skill: {
                    type: 'fireBoost',  // UNIQUE type for Valor
                    colors: [0xff0000, 0xff6600, 0xffaa00, 0xffdd00, 0xffffff],
                    scale: 0.85,
                    impacts: 5,  // Multiple impact bursts
                    screenShake: 0.5
                }
            }
        }
    ...
    m1: {
        id: 'm1', name: 'Frost', cost: 1, traits: ['mage', 'elf'], color: '#8844cc',
        stats: { hp: 4500, atk: 40, def: 15, spd: 0.7, range: 3 }, mana: { max: 50, start: 30 },
        skill: {
            name: 'Frost Sigil',
            type: 'single',
            multiplier: 1.8,
            effect: 'freeze',
            stunDuration: 1000,       // Freeze target for 1 second
            slowRadius: 1,            // Slow enemies within 1 tile
            ...
            vfx: {
                ...
                skill: {
                    type: 'frostSigil',
                    colors: [0xaaddff, 0x88ccff, 0xffffff],
                    scale: 1.2,
                    textType: 'damage'
                }
            }
    ...
    w1: {
        id: 'w1', name: 'Fang', cost: 1, traits: ['warrior', 'beast'], emoji: '🐺', color: '#cc8844',
    ...
    // ==================== TIER 2 (Cost 2) ====================
    k2: {
        id: 'k2', name: 'Aurora', cost: 2, traits: ['knight', 'elf'], emoji: '❄️', color: '#66aadd',
    ...
    m2: {
        id: 'm2', name: 'Ember', cost: 2, traits: ['mage', 'demon'], emoji: '🔥', color: '#cc4444',
    ...
    a2: {
        id: 'a2', name: 'Storm', cost: 2, traits: ['archer', 'human'], emoji: '⚡', color: '#44cc88',
    ...
    t2: {
        id: 't2', name: 'Drake', cost: 2, traits: ['tank', 'dragon'], emoji: '🐉', color: '#cc6644',
    ...
    as2: {
        id: 'as2', name: 'Blight', cost: 2, traits: ['assassin', 'undead'], emoji: '💀', color: '#446644',
    ...
    w2: {
        id: 'w2', name: 'Blade', cost: 2, traits: ['warrior', 'human'], emoji: '🗡️', color: '#888844',
    ...
    // ==================== TIER 3 (Cost 3) ====================
    k3: {
        id: 'k3', name: 'Drakon', cost: 3, traits: ['knight', 'dragon'], emoji: '🐲', color: '#ff8844',
    ...
    m3: {
        id: 'm3', name: 'Lich', cost: 3, traits: ['mage', 'undead'], emoji: '🧟', color: '#668844',
    ...
    a3: {
        id: 'a3', name: 'Talon', cost: 3, traits: ['archer', 'beast'], emoji: '🦅', color: '#aa8844',
    ...
    t3: {
        id: 't3', name: 'Grim', cost: 3, traits: ['tank', 'undead'], emoji: '🏰', color: '#555555',
    ...
    s2: {
        id: 's2', name: 'Sol', cost: 3, traits: ['support', 'dragon'], emoji: '☀️', color: '#ffaa00',
    ...
    // ==================== TIER 4 (Cost 4) ====================
    k4: {
        id: 'k4', name: 'Seraph', cost: 4, traits: ['knight', 'celestial'], emoji: '👼', color: '#ffddff',
    ...
    as3: {
        id: 'as3', name: 'Reaper', cost: 4, traits: ['assassin', 'demon'], emoji: '😈', color: '#884444',
    ...
    m4: {
        id: 'm4', name: 'Eldritch', cost: 4, traits: ['mage', 'void'], emoji: '🌀', color: '#664488',
    ...
    w3: {
        id: 'w3', name: 'Dragoon', cost: 4, traits: ['warrior', 'dragon'], emoji: '⚔️🐉', color: '#cc6622',
    ...
    // ==================== TIER 5 (Cost 5) ====================
    d1: {
        id: 'd1', name: 'Bahamut', cost: 5, traits: ['dragon', 'celestial'], emoji: '🌟🐉', color: '#ffdd00',
    ...
    v1: {
        id: 'v1', name: 'Abyss', cost: 5, traits: ['undead', 'void'], emoji: '🕳️', color: '#111133',
